...
class CruisePropertiesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $parentMtTx = $this->saveTaxonomyPath('taxonomies.cruise_meta');
        $parentClTx = $this->saveTaxonomyPath('taxonomies.cruise_classification');
        $categoryTx = $this->saveTaxonomyPath('taxonomies.cruise_properties.category', $parentClTx);

        foreach (Config::get('taxonomies.cruise_properties.categories') as $classificationData) {
            $properties = [
