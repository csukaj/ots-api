...
from ots.offer.fixed_price_offer import FixedPriceOffer


class TestSwitchCalculator(unittest.TestCase):
    def test_get_offer_when_there_is_no_switch_wrapper(self):
        meal_offer = SwitchCalculator(
            ...
            deduction_base_prices={"Child 0-3": 2},
        ).get_offer(
            meal_plan_id=2,
        ...
        self.assertEqual(meal_offer.get("price_rows"), {})

    def test_get_offer_when_there_is_an_empty_switch_wrapper(self):
        meal_offer = SwitchCalculator(
            from_time=datetime(2019, 5, 1),
            to_time=datetime(2019, 5, 10),
            subject_type="App\\Device",
    ...
    def test_get_offer_when_there_is_a_non_empty_switch_wrapper_without_offer(self):
        ...
        class PriceModifierMock(PriceModifier): pass
        ...
        def copy(self, attributes=None):
            ...
            return PriceModifierMock(**attributes)
            
        PriceModifierMock.copy = copy
        ...
        price_modifier = PriceModifierMock(
            ...
            combination_from_time=datetime(2019, 5, 1),
            combination_to_time=datetime(2019, 5, 5),
            deduction_base_prices_of_switch={"Child 0-3": 2},
            offer=None,
            properties={
    ...
    def test_get_offer_when_there_is_a_price_modifier_with_returning_fix_modification(self):
        ...
        PriceModifierMock.copy = mock.MagicMock(
            return_value=PriceModifierMock()
        )
        ...
        self.assertEqual(meal_offer.summary.net, 190)
        self.assertEqual(meal_offer.summary.rack, 290)
